...
int main(void)
{
  ...
  MX_UART5_Init();
  /* USER CODE BEGIN 2 */
  // Keep user button for 3 second, stay at bootloader, otherwise jump to application
...
static void goto_application(void)
{
  ...
  HAL_GPIO_WritePin(LED_12_GPIO_Port, LED_12_Pin, GPIO_PIN_RESET );    //Green LED OFF
